<?php
$titre = 'Salle 1'; // utiliser pour la navbar
$nbrNotification = 4; // utiliser par le include notification
$numeroSalle = 1; //utiliser pour preciser aux fonctions appelées quelle salle les mesures concernent
require('./outillage/fonctions.php');
$connexion = gestionConnexionUtilisateur(); // utiliser pour invoquer les fonctions de outillage/fonction
require_once("./include/head.php") ?>

<body>
<div class="container">
    <!-- Barre de navigation de la page salle-->
